package com.lqb.android.shopping.shoppingcart.adapter;
...
public class ShopCartAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShopCartAdapter(Context context, final List<GoodsBean> datas,
                           TextView tvShopcartTotal, CartProvider cartProvider,
                           CheckBox checkboxAll, CheckBox cb_all) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            numberAddSubView = (NumberAddSubView) itemView.findViewById(R.id.AddSubView);
        ...
        public void setData(final GoodsBean goodsBean) {
            ...
            numberAddSubView.setOnNumberChangeListener(
        ...
        if (datas != null && datas.size() > 0) {
            for (int i = 0; i < datas.size(); i++) {
                ...
                if (goodsBean.isChildSelected())
                    total += Double.parseDouble(goodsBean.getCover_price()) *
