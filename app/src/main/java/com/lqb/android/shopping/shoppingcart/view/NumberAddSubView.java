package com.lqb.android.shopping.shoppingcart.view;
...
public class NumberAddSubView extends LinearLayout implements View.OnClickListener {
    ...
    public NumberAddSubView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            // 取出属性
            TintTypedArray tintTypedArray = TintTypedArray.obtainStyledAttributes(context,
                                            attrs, R.styleable.NumberAddSubView);
            ...
            int maxValue = tintTypedArray.getInt(R.styleable.NumberAddSubView_minValue, 0);
            if (value > 0) {
                setMaxValue(maxValue);
            }

            Drawable addDrawable = tintTypedArray.getDrawable(
                                    R.styleable.NumberAddSubView_numberAddBackground);
            if (addDrawable != null) {
                btn_add.setImageDrawable(addDrawable);
            }

            Drawable subDrawable = tintTypedArray.getDrawable(
